...
//import com.psychotalk.repository.UserRepoOld;
...
//        Users dbUser = userRepoOld.findByEmail(user.getEmail());
//        Users dbUserName = userRepoOld.findByUserName(user.getUsername());
...
//        Users dbUser = userRepoOld.findByUserEmailAndUserPassword(user.getEmail() , user.getPassword());
//        if(dbUser != null){
...
//            userRepoOld.save(dbUser);
//            return dbUser;
//        }else{
//            Users newUser =  userRepoOld.findByUserName(user.getUsername());
//            if(newUser == null){
//                Date date = getDate();
//                dbUser.setModifiedTime(date);
//                dbUser.setAge(user.getAge());
...
//        Users dbUser = userRepoOld.getUserById(userId);
//        if(dbUser != null){
//            return  getUserJson(dbUser);
//        }else{
//            return "{\"status\":\"failure\",\"errorMsg\":\"Incorrect Username or password\"}";
